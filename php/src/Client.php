...
namespace APIVerve\Initialismgenerator;
...
/**
 * Client for the Initialism Generator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/initialismgenerator?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/initialismgenerator';
    ...
    private const VALIDATION_RULES = [
        ...
        'excludeCommonWords' => ['type' => 'boolean', 'required' => false],
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\InitialismgeneratorClient] {$message}\n";
        }
    }
}
