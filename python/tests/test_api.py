...
class TestInitialismgeneratorAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = InitialismgeneratorAPIClient(self.api_key)

    @patch('apiverve_initialismgenerator.apiClient.requests.get')
