...
// Request contains the parameters for the Initialism Generator API.
//
// Parameters:
...
type Request struct {
	Phrase string `json:"phrase"` // Required
	Uppercase bool `json:"uppercase,omitempty"` // Optional
}
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		"phrase": {Type: "string", Required: true, MaxLength: intPtr(500)},
...
// ResponseData contains the data returned by the Initialism Generator API.
