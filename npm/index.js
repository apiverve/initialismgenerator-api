...
class initialismgeneratorWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/initialismgenerator');
        }
        ...
        this.validationRules = {"phrase":{"type":"string","required":true,"maxLength":500},"excludeCommonWords":{"type":"boolean","required":false,"default":false},"uppercase":{"type":"boolean","required":false,"default":true}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/initialismgenerator`);
        }
    }
...
module.exports = initialismgeneratorWrapper;
