...
namespace APIVerve.API.InitialismGenerator
{
    ...
    /// <summary>
    /// Client for the InitialismGenerator API
    /// </summary>
    public class InitialismGeneratorAPIClient
#if !NET20 && !NET35 && !NET40
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/initialismgenerator";
        ...
        {
            { "phrase", new ValidationRule { Type = "string", Required = true, MaxLength = 500 } },
            { "excludeCommonWords", new ValidationRule { Type = "boolean", Required = false } },
            { "uppercase", new ValidationRule { Type = "boolean", Required = false } }
        };
        ...
        public InitialismGeneratorAPIClient(string apiKey)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public InitialismGeneratorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public InitialismGeneratorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, InitialismGeneratorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(InitialismGeneratorQueryOptions options)
        {
        ...
        public ResponseObj Execute(InitialismGeneratorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(InitialismGeneratorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(InitialismGeneratorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(InitialismGeneratorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(InitialismGeneratorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(InitialismGeneratorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(InitialismGeneratorQueryOptions options)
        {
