# Initialism Generator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:initialismgenerator-api:1.1.14'
}
```
...
```java
import com.apiverve.initialismgenerator.InitialismGeneratorAPIClient;
import com.apiverve.initialismgenerator.APIResponse;
import com.apiverve.initialismgenerator.APIException;

// Initialize the client
InitialismGeneratorAPIClient client = new InitialismGeneratorAPIClient("YOUR_API_KEY");

try {
    // Prepare request parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("phrase", "Application Programming Interface");
    parameters.put("excludeCommonWords", true);
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/initialismgenerator](https://docs.apiverve.com/ref/initialismgenerator)
...
- **Documentation:** [https://docs.apiverve.com/ref/initialismgenerator](https://docs.apiverve.com/ref/initialismgenerator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/initialismgenerator-api/issues)
